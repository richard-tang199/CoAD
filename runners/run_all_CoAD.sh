...
#do
# python train_classify_mask.py --dataset_name TSB-AD  --group_name $g --model_name freq_tf_v2 --device "cuda:0" --plot True --num_epochs 300 --batch_size 128 --window_multiple 4 --lr 2e-3 --patch_size 8 --omega 10
#done
#
