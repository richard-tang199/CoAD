...
- <mark>The 64 subsets of TSB-AD used in the paper can be found in the `runners/run_all_CoAD.sh` file, including MGAB, SED, SVDB, IOPS and TODS benchmark datasets.</mark>
